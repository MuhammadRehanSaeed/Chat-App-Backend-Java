package com.rehancode.chatapp.Security;
...
import com.rehancode.chatapp.JWT.JwtFilter;
...
public CorsConfigurationSource corsConfigurationSource() {
    ...
    config.setAllowedOrigins(List.of("http://localhost:5173", "http://192.168.18.81:5173"));
